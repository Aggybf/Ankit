...
function BgminameCreate() {
  ...
  useEffect(() => {
    normal("bgmi name create");
  }, []);
  return (
    <>
      <Helmet>
        {/* all meta tags here  */}
        <title>#1 BGMI Name Create Free ฿฿</title>
        <link rel="canonical" href="https//iamvicky.dev/bgmi-name-create" />
       <meta name="description" content="Transform your BGMI journey with our bgmi name create tool, infusing emotion into your gaming persona. Craft unique and stylish usernames that resonate with the heart of your gaming adventure, creating an unforgettable and emotionally charged gaming experience." />
       <meta property="og:type" content="article" />
       <meta property="og:title" content="#1 BGMI Name Create Free ฿฿" />
       <meta property="og:description" content="Transform your BGMI journey with our bgmi name create tool, infusing emotion into your gaming persona. Craft unique and stylish usernames that resonate with the heart of your gaming adventure, creating an unforgettable and emotionally charged gaming experience." />
       <meta property="og:url" content="https://iamvicky.dev/bgmi-name-create" />
       <meta property="og:site_name" content="iamvicky" />
       <meta name="keywords" content="BGMI, BGMI Name Generator, BGMI Username, Battlegrounds Mobile India, Game Name Generator, bgmi name create" />
        <meta property="og:image" content="/images/Bgmi-name-create.png" />
      </Helmet>
      <Toaster position="bottom-right" reverseOrder={false} />
      <div className="mn">
        <center>
          {" "}
          <h2>{tt ? tt : "BGMI Name Create Online Free"}</h2>
        </center>
        <center>
          <AdSenseComponent />
        </center>
        ...
        <div className="ft">
          <header>
            <img
              src="../images/Bgmi-name-create.png"
              alt="fancy text img"
              width="100%"
              height="auto"
            />
            ...
            <h1>BGMI Name Create Free Tool</h1>
            <p>Create your stylish in game name with our "BGMI name creator tools it has 200+ stylish font that perfectly work on all devices."</p>
            <center>
            <AdSenseComponent />
          </center>

            <h2>How to use Bgmi name Creator tools?</h2>
            <ul>
                <li>Go to this site <a href="https://iamvicky.dev/bgmi-name-create/">Bgmi name create</a></li>
                <li>In search box enter your choice name</li>
                <li>Now click on generate button</li>
                <li>Below you will get 200+ generated stylish name of you entered name.</li>
                <li>Now which you want just click. It will automatically copy that.</li>
            </ul>
          </header>
          <center>
            <AdSenseComponent />
          ...
          <center>
            ...
            >
              Copyright © 2022 <a href="https://iamvicky.dev">BGMI Name Generator</a>
            </p>
          </center>
        </div>
      </div>
